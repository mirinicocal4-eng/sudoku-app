...
export const CityMap = ({ unlockedCases, setCurrentCase, setView, evidenceCount }) => {
  return (
    <>
      ...
      <div className="city-map-container" style={{
        ...
        {PUNTOS_MAPA.slice(0, unlockedCases).map((p, i) => (
          <div key={i} className="case-pin" style={{left:`${p.x}%`, top:`${p.y}%`}} onClick={() => {setCurrentCase(i+1); setView('selector');}}>
